...
- Intent provider registry entries must parse and capture their selected provider config and constructor during runtime config loading; central intent config retains only the provider ID and a neutral resolved factory.
