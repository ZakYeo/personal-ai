...
- OpenAI intent semantics must fail safely when a required string parameter merely echoes the whole request or a narrow action question is misclassified as a broad capability-list request; return one canonical clarification instead of executing the provider's guess.
