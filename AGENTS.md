...
- Calendar titles must be emoji-free at the application boundary. A separately configured narrow event-grouping provider may combine only clearly connected same-day entries, selecting at most four important milestones while retaining every original event reference and exact fact; invalid or failed grouping falls back to the ungrouped result with internal diagnostics.
