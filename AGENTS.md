...
- Keep one process-local pending interaction per assistant instance: confirmation or one resumable clarification. No/cancel discards a clarification; other input resumes the exact provider session; a resulting validated confirmation replaces it.
