...
- Intent and conversation provider registry entries must parse and capture their selected provider config and constructor during runtime config loading; central operation config retains only common fields, the provider ID, and a neutral resolved factory.
