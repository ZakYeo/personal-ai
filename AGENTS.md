...
- Tool observations contain only safe response text, scalar protected data, and opaque public references. Never expose diagnostics, credentials, raw provider payloads, private result targets, or provider IDs through the intent session.
