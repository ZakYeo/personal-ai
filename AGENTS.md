...
- The current product milestone is alarm usability and lifecycle controls: snooze, rescheduling, label editing, and human status are implemented; add recurrence and retention serialized with scheduler observation and covered by deterministic restart tests.
