...
- Desktop streaming provider registry entries must capture their typed config and constructor behind provider-neutral slot selections; do not add provider-specific IDs or config unions to neutral voice types.
