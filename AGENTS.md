...
- `npm run benchmark:voice:capture -- --speaker primary` - interactively capture only missing personal voice benchmark phrases through SoX, retain one second of trailing silence, and require consent before promotion.
