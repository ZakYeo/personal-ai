...
- Deterministic calendar responses should preserve exact provider date strings; core may restore protected ISO-date facts through explicit deterministic renderings such as today or tomorrow after optional rewriting, while providers may only humanize surrounding wording.
