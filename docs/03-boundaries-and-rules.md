...
Intent and conversation provider entries also parse their selected raw provider
section and capture typed construction at config load time. Central operation
config must not accumulate provider-specific optional fields or discriminated
provider unions; conversation history remains a common central field.
