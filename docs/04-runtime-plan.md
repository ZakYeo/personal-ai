...
Intent selection follows the same registry-owned parsing boundary, leaving the
loaded intent config with its provider ID and a captured neutral interpreter
factory rather than provider-specific config fields.
